window.onload = (function () {
    ...
    outputButton.onclick = function validateInput() {
        ...
        var isDateValid = isDateStringValid(inputDate, selectedInputFormatValue) &&
            dateFormatter.formatDate(inputDate, selectedInputFormatValue, selectedOutputFormatValue);
        ...
        if (inputDate !== '' && isDateValid && selectedInputFormatValue !== 'Not selected' &&
            selectedOutputFormatValue !== 'Not selected') {
            resultLog.innerHTML = 'Result: ' + dateFormatter.formatDate(inputDate,
                selectedInputFormatValue, selectedOutputFormatValue);
        } else {
            resultLog.innerHTML = '';
        }
    };
